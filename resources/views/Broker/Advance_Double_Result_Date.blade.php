        ...
        <div class="col-12 col-xl-7 col-lg-7 col-md-11 col-sm-12 card badge-theme-black">
          <div class="card-header ">
            <div class="card-title ">
              <h4 class="text-uppercase font-weight-bolder line-height-1 text-warning">
                SEE History
              </h4>
          ...
          <div class="card-content collapse show  p-0 pb-3 px-1 ">
            ...
            <div class="input-group">
              <a class="w-100" href="{{route('Dated-Double-Result')}}">
                <button type="button" class=" w-100 btn btn-warning btn-md btn-radius">Go
                </button>
              </a>
            </div>
          </div>
