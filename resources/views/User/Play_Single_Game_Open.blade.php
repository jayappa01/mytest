        ...
        <div class="col-12 card badge-black ">
          <div class="card-header pl-0 pb-0">
            <div class="card-title">
              <h5 class="text-uppercase font-weight-bolder line-height-1 text-danger">
              ...
              <div class="col-12 col-xl-7 col-lg-7 col-md-11 col-sm-12 p-0">
                ...
                <div class="tab-content " id="nav-tabContent">
                  ...
                  <div class="tab-pane Game-unit-container fade" id="nav-Total" role="tabpanel"
                    ...
                    <div class="input-group pb-2">
                      <input type="text"
                        class="p-2 border-0 no-border-top-radius bg-white darken-4 form-control text-center font-weight-bold badge-light font-20px"
