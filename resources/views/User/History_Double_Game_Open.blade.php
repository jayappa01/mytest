              ...
              <div class="col-12 col-xl-7 col-lg-7 col-md-11 col-sm-12 p-0">
                ...
                <div class="tab-content " id="nav-tabContent">
                  ...
                  <div class="tab-pane Game-unit-container fade" id="nav-Jodi" role="tabpanel"
                    ...
                    <div class="input-group pb-2">
                      <input type="text"
                        class="p-2 border-0 no-border-top-radius bg-primary darken-4 form-control text-center font-weight-bold badge-dark text-black font-20px"
                    ...
                    <div id="collapse3" class="card-accordion">
                      <div class="card badge-black collapse-icon accordion-icon-rotate">
                        ...
                        <div class="card badge-black pb-1 declared-jodi ">
                          ...
                          <div id="collapseC0-9" class="collapse show bg-blue-grey bg-darken-4 rounded-bottom "
                            ...
                            <div class="card-body">
                              <div class="row  ">
                                ...
                                <div class="input-group p-4-b p-4-x w-50 declared-jodi-num">
                                  <div class="input-group-prepend">
                                    <span
                      ...
                      <div class="rounded-sm border-danger border-lighten-2 bg-danger bg-lighten-3 p-4px w-100 mt-1">
                        ...
                        <div class="p-4-t">
                          <div class="w-100 rounded-lg border-danger bg-danger bg-darken-3 p-4-y ">
                            <div
                              ...
                              ⇣ Figure + Pana + Jodi = <b class="text-white">Total Of Fasi</b> ⇣
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="p-4-t">
                          <div class="input-group row m-0 ">
                            <div class="input-group-prepend p-0 col-6 col-sm-5 col-md-4 col-lg-5 col-xl-4 ">
                              <span
                                class="w-100 bg-primary bg-lighten-3 border-red text-dark input-group-text font-weight-bold font-20px py-0 p-4-x">
                                Fasi Jodi ⇉</span>
                            </div>
                            <input type="text"
                              class="col-6 col-sm-7 col-md-8 col-lg-7 col-xl-8 py-2 px-0 form-control text-center font-weight-bold bg-red bg-accent-2 border-red text-black font-20px"
                              value="Fasi Jodi" placeholder="Fasi Jodi" readonly>
                          </div>
                        </div>
                        ...
                        <div class="p-4-t">
                          <div class="w-100 rounded-lg border-dark bg-dark bg-darken-3 p-4-y ">
                            <div
                              ...
                              ⇣ Open Total - 10% = <b class="text-white">Total</b> ⇣
                            </div>
                          </div>
                        </div>
