            ...
            <div class="w-100 d-flex justify-content-center p-0">
              ...
              <div class="col-12 col-xl-7 col-lg-7 col-md-11 col-sm-12 p-0">
                <div class="row p-0 m-0">
                  <h3 class="badge-danger rounded-top text-dark font-weight-bold p-4-y px-1 pt-1 m-0"><i
                      class="icon-calendar"></i> <?= date("d/m/Y") ?></h3>
                </div>
                <div class="badge-danger rounded-top no-border-top-left-radius text-center m-0 p-1">
                  <h2 class="p-0 m-0 text-white w-100 font-weight-bold text-uppercase pb-1 ">Game Name</h2>
                  <h3 class="p-0 m-0 text-dark font-weight-bold float-left"><i class="icon-clock"></i> 01.30 PM</h3>
                  <h3 class="m-0 float-right btn btn-warning btn-sm font-medium-1 "><i class="icon-game-controller"></i>
                    123-6
                  </h3>
                  <h4 class="p-0 p-4-y m-0 text-white font-weight-bold"><i class="ft-phone"></i></h4>
                </div>
                <div class="nav nav-tabs badge-danger no-border-top-radius nav-justified" id="nav-tab" role="tablist">
                ...
                <div class="tab-content " id="nav-tabContent">
                  <div class="tab-pane Game-unit-container fade" id="nav-Figure" role="tabpanel"
                    ...
                    <div class="input-group pb-2">
                      <input type="text"
                        class="p-2 border-0 no-border-top-radius bg-danger bg-accent-4 form-control text-center font-weight-bold badge-light font-20px"
                        value="⇣  Write your Figure  ⇣" placeholder="Close Total" readonly>
                    </div>
                    <div class="input-group p-4-b">
                      <div class="input-group-prepend">
                        <span class="badge-danger input-group-text font-weight-bold font-20px py-0">1⇢</span>
                      </div>
                    ...
                    <div class="input-group p-4-b">
                      <div class="input-group-prepend">
                        <span class="badge-danger input-group-text font-weight-bold font-20px py-0">2⇢</span>
                      </div>
                      <input type="number" max="200000" min="0" oninput="validity.valid||(value='');"
                        class="py-1 px-0 form-control text-center font-weight-bold badge-dark text-black font-20px"
                        value="123456789" maxlength="5" readonly>
                    ...
                    <div class="input-group p-4-b">
                      <div class="input-group-prepend">
                        <span class="badge-danger input-group-text font-weight-bold font-20px py-0">3⇢</span>
                      </div>
                      <input type="number" max="200000" min="0" oninput="validity.valid||(value='');"
                        class="py-1 px-0 form-control text-center font-weight-bold badge-dark text-black font-20px"
                        value="123456789" maxlength="5" readonly>
                    </div>
                    <div class="input-group p-4-b Bonus-figure-declared">
                      <div class="input-group-prepend">
                        <span class="badge-danger input-group-text font-weight-bold font-20px py-0">4⇢</span>
                      </div>
                      <input type="number" max="200000" min="0" oninput="validity.valid||(value='');"
                        class="py-1 px-0 form-control text-center font-weight-bold badge-dark text-black font-20px"
                        value="123456789" maxlength="5" readonly>
                    ...
                    <div class="input-group p-4-b">
                      <div class="input-group-prepend">
                        <span class="badge-danger input-group-text font-weight-bold font-20px py-0">5⇢</span>
                      </div>
                      <input type="number" max="200000" min="0" oninput="validity.valid||(value='');"
                        class="py-1 px-0 form-control text-center font-weight-bold badge-dark text-black font-20px"
                        value="123456789" maxlength="5" readonly>
                    ...
                    <div class="input-group p-4-b figure-declared">
                      <div class="input-group-prepend">
                        <span class="badge-danger input-group-text font-weight-bold font-20px py-0">6⇢</span>
                      </div>
                      <input type="number" max="200000" min="0" oninput="validity.valid||(value='');"
                        class="py-1 px-0 form-control text-center font-weight-bold badge-dark text-black font-20px"
                        value="123456789" maxlength="5" readonly>
                    ...
                    <div class="input-group p-4-b">
                      <div class="input-group-prepend">
                        <span class="badge-danger input-group-text font-weight-bold font-20px py-0">7⇢</span>
                      </div>
                      <input type="number" max="200000" min="0" oninput="validity.valid||(value='');"
                        class="py-1 px-0 form-control text-center font-weight-bold badge-dark text-black font-20px"
                        value="123456789" maxlength="5" readonly>
                    ...
                    <div class="input-group p-4-b">
                      <div class="input-group-prepend">
                        <span class="badge-danger input-group-text font-weight-bold font-20px py-0">8⇢</span>
                      </div>
                      <input type="number" max="200000" min="0" oninput="validity.valid||(value='');"
                        class="py-1 px-0 form-control text-center font-weight-bold badge-dark text-black font-20px"
                        value="123456789" maxlength="5" readonly>
                    ...
                    <div class="input-group p-4-b">
                      <div class="input-group-prepend">
                        <span class="badge-danger input-group-text font-weight-bold font-20px py-0">9⇢</span>
                      </div>
                      <input type="number" max="200000" min="0" oninput="validity.valid||(value='');"
                        class="py-1 px-0 form-control text-center font-weight-bold badge-dark text-black font-20px"
                        value="123456789" maxlength="5" readonly>
                    ...
                    <div class="input-group pb-2">
                      <div class="input-group-prepend">
                        <span class="badge-danger input-group-text font-weight-bold font-20px py-0">0⇢</span>
                      </div>
                      <input type="number" max="200000" min="0" oninput="validity.valid||(value='');"
                        class="py-1 px-0 form-control text-center font-weight-bold badge-dark text-black font-20px"
                        value="123456789" maxlength="5" readonly>
                    ...
                    <div class="input-group pb-2">
                      <div class="input-group-prepend">
                        <span class="badge-danger input-group-text font-weight-bold font-20px py-0 p-4-x">Figure
                          Total⇢</span>
                      </div>
                      <input type="text"
                  ...
                  <div class="tab-pane Game-unit-container fade show active" id="nav-Total" role="tabpanel"
                    ...
                    <div class="input-group pb-2">
                      <input type="text"
                        class="p-2 border-0 no-border-top-radius bg-white text-dark form-control text-center font-weight-bold font-20px"
                    ...
                    <div class="mb-2  border-3 border-pink border-lighten-4 rounded-lg bg-pink bg-lighten-4">

                      <div class="w-100 rounded border border-black bg-pink bg-lighten-4 ">
                      ...
                      <div class="p-4-t">
                        <div class="w-100 rounded border border-dark bg-pink bg-accent-1 p-4-y ">
                          <div class="p-4-y text-uppercase text-center font-weight-bold font-20px text-black ">
                            Open Result:- <b class="text-blue">123⇢6</b>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="p-4-t">
                        <div class="input-group row m-0 ">
                          <div class="input-group-prepend p-0 col-5 col-sm-4 col-md-3 col-lg-4 col-xl-3 ">
                            <span
                              class="w-100 badge-danger text-dark input-group-text font-weight-bold font-20px py-0 p-4-x">
                              Figure Total⇢</span>
                          </div>
                          <input type="text"
                            class="col-7 col-sm-8 col-md-9 col-lg-8 col-xl-9 py-2 px-0 form-control text-center font-weight-bold bg-danger bg-accent-2 text-black font-20px"
                      ...
                      <div class="rounded-sm border-white border-lighten-2 bg-white bg-lighten-3 p-4px w-100 mt-1">
                        ...
                        <div class="p-4-t">
                          <div class="input-group row m-0 ">
                            <div class="input-group-prepend p-0 col-6 col-sm-5 col-md-4 col-lg-5 col-xl-4 ">
                              <span
                                class="w-100 bg-danger bg-lighten-1 border-red text-dark input-group-text font-weight-bold font-20px py-0 p-4-x">
                        ...
                        <div class="p-4-t bell-shake w-100">
                          <div class="input-group row m-0 ">
                            <div class="input-group-prepend p-0 col-6 col-sm-5 col-md-4 col-lg-5 col-xl-4 ">
                              <span
                                class="w-100 bg-purple bg-darken-4 shadow border-warning text-red input-group-text font-weight-bold font-20px py-0 p-4-x">
                                <b class="text-warning">Bonus</b>&nbsp;Fasi x 20 ⇉</span>
                            </div>
                            <input type="text"
                              class="col-6 col-sm-7 col-md-8 col-lg-7 col-xl-8 py-2 px-0 form-control text-center font-weight-bold bg-purple bg-darken-3 shadow border-warning text-warning font-20px"
                              value="Fasi Figure" placeholder="Fasi Figure" readonly>
                          </div>
                        </div>
                        ...
                        <div class="p-4-t bell-shake w-100">
                          <div class="input-group row m-0 ">
                            <div class="input-group-prepend p-0 col-6 col-sm-5 col-md-4 col-lg-5 col-xl-4 ">
                              <span
                                class="w-100 bg-purple bg-darken-4 shadow border-warning text-red input-group-text font-weight-bold font-20px py-0 p-4-x">
                                <b class="text-warning">Bonus</b>&nbsp;Fasi x 18 ⇉</span>
                            </div>
                            <input type="text"
                              class="col-6 col-sm-7 col-md-8 col-lg-7 col-xl-8 py-2 px-0 form-control text-center font-weight-bold bg-purple bg-darken-3 shadow border-warning text-warning font-20px"
                              value="Fasi Figure" placeholder="Fasi Figure" readonly>
