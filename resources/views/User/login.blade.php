...
<head>
  ...
  <!-- BEGIN: Custom CSS-->
  <link rel="stylesheet" type="text/css" href="{{ public/asset('assets/css/style.css')}}">
  <!-- END: Custom CSS-->
...
<body class="vertical-layout vertical-menu-modern 1-column  bg-gradient-x-orange-yellow blank-page blank-page"
  data-open="click" data-menu="vertical-menu-modern" data-color="bg-gradient-x-purple-red" data-col="1-column">
  <!-- BEGIN: Content-->
  <div class="flexbox-container bg-hexagons-danger ">
            ...
            <div class="col-lg-4 col-md-6 col-10 box-shadow-2 p-0">
              <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                ...
                <div class="card-content">
                  ...
                  <div class="card-body">
                    <form class="form-horizontal" action="{{route('User-Dashboard')}}" novalidate>
                      <fieldset class="form-group position-relative has-icon-left">
                        <input type="text" class="form-control round" id="user-name" placeholder="Your Username"
                          required>
                      ...
                      <div class="form-group text-center">
                        <button type="submit"
                          class="btn round btn-block btn-glow btn-bg-gradient-x-orange-yellow col-12 mr-1 mb-1">Login</button>
                      </div>

                    </form>
                  </div>
                  <p class="card-subtitle text-muted text-center font-small-3 mx-2 my-1"><span>Don't have an account ?
                      <a href="register.html" class="card-link">Sign Up</a></span></p>
                </div>
              </div>
            </div>
          </div>
