        ...
        <div class="col-12 col-xl-7 col-lg-7 col-md-11 col-sm-12 card badge-black">
          ...
          <div class="card-content collapse show  p-0 pb-3 px-1 ">
            ...
            <div class="form-group">
              <div class="position-relative has-icon-left ">
                <input type="date" id="projectinput3" class="form-control text-center" name="date" data-toggle="tooltip"
                  data-trigger="hover" data-placement="top" data-title="Select Date" required>
            ...
            <div class="input-group">
              <a class="w-100" href="{{route('History-Type')}}">
                <button type="button" class=" w-100 btn btn-danger btn-md btn-radius">Go
                </button>
              </a>
            </div>
          </div>
